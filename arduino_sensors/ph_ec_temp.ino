...
OneWire oneWire(DS18S20_Pin);   // Setup a oneWire instance to communicate with any OneWire device
DallasTemperature ds(&oneWire);  // Pass oneWire reference to DallasTemperature library
DFRobot_PH ph;
DFRobot_EC ec;
...
float readTemperature()
{
  ...
  return ds.getTempCByIndex(0);   // one wire communication device
